...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
		...
		getSearchResults: function getSearchResults(searchTerm) {
			...
			var self = this;
			axios.get("https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key=" + authKey + "&q=" + searchTerm).then(function (httpRes) {
		...
		handleClick: function handleClick() {
			...
			if (this.state.searchTerm.trim() !== "") this.getSearchResults(this.state.searchTerm);
		},
